...
<div class="container">
		<h2 style=" width: 100%; border-bottom: 4px solid #F4A460"><b>Manual Aplikasi</b></h2>
	<div class="bs-acc">
			...
			<div class="panel panel-default">
				...
				<div class="panel-heading" style="background-color: #eee;">
					<h4 class="panel-title">
						Bagaimana Cara Berbelanja di Abel Bakery ?
					</h4>
				</div>
				</a>
				<div id="collapseOne" class="panel-collapse collapse in">
					<div class="panel-body">
						<ol>
							...
							<li>Pilih tanggal dan jam pengiriman</li>
							<li>Tunggu konfirmasi via Whatsapp dari admin Abel Bakery</li>
						</ol>
					</div>
				</div>
			</div>
