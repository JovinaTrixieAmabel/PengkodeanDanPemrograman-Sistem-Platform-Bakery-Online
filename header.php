	...
	<div class="container-fluid">
		<div class="row top">
			<center>
				...
				<div class="col-md-4"  style="padding: 3px;">
					<span><i class="glyphicon glyphicon-envelope"></i> abelbakery@gmail.com</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span>Abel Bakery</span>
				</div>
			</center>
		</div>
	</div>
	...
	<nav class="navbar navbar-default" style="padding: 5px;">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#" style="color: #000000"><b>ABEL BAKERY</b></a>
			</div>
